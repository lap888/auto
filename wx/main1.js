 ...
 * @Last Modified time: 2023-01-26 15:07:40
 */
//定义全局变量
let window;
let sub_log = true;
...
function core() {
    ...
    //fullId = com.tencent.mm:id/f2a
    FindClickUi('com.tencent.mm:id/f2a', true)
    sleep(3500)

    log('::点击视频号')
    //fullId = com.tencent.mm:id/kp3
    FindClickUi('com.tencent.mm:id/kp3', true)
    sleep(3500)

    log('::点击放大镜')
    //fullId = com.tencent.mm:id/jk4
    FindClickUi('com.tencent.mm:id/jk4', true)
    sleep(3500)
    ...
    sleep(3500)
    log('::点击搜索')
    let isHaveSbtn=id('com.tencent.mm:id/m6r').exists()  //desc('小程序、公众号、文章、朋友圈和表情等按钮').exists()
    ...
    while (!isHaveSbtn) {
        ...
        isHaveSbtn=id('com.tencent.mm:id/m6r').exists()
        log('ishave',isHaveSbtn)
        continue;
    }
    sleep(3500)
    //let tmp = desc('小程序、公众号、文章、朋友圈和表情等按钮').visibleToUser().findOnce()
    let tmp=id('com.tencent.mm:id/m6r').findOnce()
    if (tmp) {
        log(1)
        let tmp2 = tmp.bounds()
